...
class RoleWorkResourceIT {
    ...
    void checkNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = roleWorkRepository.findAll().size();
        // set the field null
        roleWork.setName(null);

        // Create the RoleWork, which fails.
        ...
        List<RoleWork> roleWorkList = roleWorkRepository.findAll();
        assertThat(roleWorkList).hasSize(databaseSizeBeforeTest);
    }
