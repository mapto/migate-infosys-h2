...
import it.unimi.dllcm.migate.domain.Country;
import it.unimi.dllcm.migate.repository.CountryRepository;
...
/**
 * REST controller for managing {@link it.unimi.dllcm.migate.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
