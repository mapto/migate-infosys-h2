...
public class RoleWorkResource {
    ...
    public ResponseEntity<RoleWork> createRoleWork(@Valid @RequestBody RoleWork roleWork) throws URISyntaxException {
    ...
    public ResponseEntity<RoleWork> updateRoleWork(
        ...
        @Valid @RequestBody RoleWork roleWork
    ...
    public ResponseEntity<RoleWork> partialUpdateRoleWork(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody RoleWork roleWork
    ) throws URISyntaxException {
