...
public class RoleInstitutionResource {
    ...
    public ResponseEntity<RoleInstitution> createRoleInstitution(@Valid @RequestBody RoleInstitution roleInstitution)
    ...
    public ResponseEntity<RoleInstitution> updateRoleInstitution(
        ...
        @Valid @RequestBody RoleInstitution roleInstitution
    ) throws URISyntaxException {
    ...
    public ResponseEntity<RoleInstitution> partialUpdateRoleInstitution(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody RoleInstitution roleInstitution
    ) throws URISyntaxException {
