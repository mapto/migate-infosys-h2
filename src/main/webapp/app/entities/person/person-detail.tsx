    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {personEntity.jobs
              ? personEntity.jobs.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.name}</a>
                    {personEntity.jobs && i === personEntity.jobs.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
          ...
          <dd>
            {personEntity.responsibilities
              ? personEntity.responsibilities.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.name}</a>
                    {personEntity.responsibilities && i === personEntity.responsibilities.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
