            ...
            <tbody>
              {languageList.map((language, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{language.person ? <Link to={`/person/${language.person.id}`}>{language.person.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/language/${language.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
