...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './work.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORK actions', async () => {
      const expectedActions = [
        {
