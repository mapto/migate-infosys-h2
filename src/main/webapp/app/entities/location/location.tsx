            ...
            <tbody>
              {locationList.map((location, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{location.sites ? <Link to={`/institution/${location.sites.id}`}>{location.sites.id}</Link> : ''}</td>
                  <td>{location.places ? <Link to={`/country/${location.places.id}`}>{location.places.id}</Link> : ''}</td>
