...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTITUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTITUTION actions', async () => {
      const expectedActions = [
        {
