        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Start" id="role-work-start" name="start" data-cy="start" type="date" />
              <ValidatedField label="End" id="role-work-end" name="end" data-cy="end" type="date" />
