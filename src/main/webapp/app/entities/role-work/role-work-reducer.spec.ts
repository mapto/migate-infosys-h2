...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './role-work.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLEWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLEWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLEWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLEWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLEWORK actions', async () => {
      const expectedActions = [
        {
