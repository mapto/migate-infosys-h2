    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {roleInstitutionEntity.start ? <TextFormat value={roleInstitutionEntity.start} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <span id="end">End</span>
          </dt>
          <dd>
            {roleInstitutionEntity.end ? <TextFormat value={roleInstitutionEntity.end} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
        </dl>
