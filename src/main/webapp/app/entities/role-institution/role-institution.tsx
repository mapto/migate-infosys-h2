            ...
            <tbody>
              {roleInstitutionList.map((roleInstitution, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {roleInstitution.start ? <TextFormat type="date" value={roleInstitution.start} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{roleInstitution.end ? <TextFormat type="date" value={roleInstitution.end} format={APP_DATE_FORMAT} /> : null}</td>
