...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEINSTITUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLEINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLEINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLEINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLEINSTITUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLEINSTITUTION actions', async () => {
      const expectedActions = [
        {
